\chapter{Technische Implementierung der Algorithmen}
	...
	\section{Kurze Einführung in die Programmiersprache und Programmierumgebung}
		...
		\subsection{Programmierumgebung STEP7}
			...
			\begin{figure}[h]
				\begin{center}
					\subfigure[FUP]{\label{Sample FUP}\includegraphics[scale=0.3]{/Bilder/SampleFUP}}
					\subfigure[SCL]{\label{Sample SCL}\includegraphics[scale=0.3]{/Bilder/SampleSCL}}
				\end{center}
	...
	\section{Realisierung der Anlagentopologie}
		...
		\subsection{Beschreibung als Knotenliste}
			\label{Knotenliste}
			Sowohl für die Wegfindung als auch für die Fahrsteuerung wird eine digitale Repräsentation der Anlage benötigt. Aufgrund der einfachen Erweiterbarkeit wurde hier die Darstellungsform der Knotenliste für Graphen ausgewählt, da bei dieser Datenstruktur einfach Knoten hinzugefügt und entfernt werden können. Für einen Einzelknoten wurde die Anzahl der möglichen Kanten auf vier beschränkt. Dies macht eine Zuordnung der einzelnen Verbindungskanten zu den vier Himmelsrichtungen möglich. Dies wird vor allem für die Fahrsteuerung benötigt, da hier eine der Anforderungen die Möglichkeit der Ausführung von 90-Grad-Kurven ist. Diese Kantenanordnung vereinfacht für die Fahrzeugsteuerung auch die Bestimmung der Abbiegerichtung an einem Knoten , da sie diese auf "`Rechts"',"`Links"',"`Geradeaus"' und "`Umdrehen"' beschränkt. Da die Fahrsteuerung als getrenntes Programmmodul implementiert wurde besitzt sie eine Kopie der Knotenliste der Anlage mit den zusätzlichen, bei der Wegfindung nicht benötigten Knoten der Rückführstrecke.
	...
	\section{Implementierung der Algorithmen}
		...
		\subsection{Priority-Queue}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.5]{/Bilder/ArrayEffizienzPDF}
				\vspace{0.2cm}
			...
			Die Operationen "`Insert"', "`Pop"' und "`UpdateNode"' beinhalten alle eine abschließende Wiederherstellung  der Prioritätsbedingung mittels der nachfolgend dargestellten "`Sort"'-Funktion:
...
END_IF;		
		...
		\subsection{Generation der Route}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.5]{/Bilder/RoutenGenerationPDF}
				\vspace{0.2cm}
	...
	\section{Einhaltung der Echtzeitbedingung}
		...
		\subsection{Ausführung bei Systemstart}
			...
			\begin{figure}
				\centering
				\includegraphics[scale=0.5]{/Bilder/StartupVsZyklusPDF}
				\vspace{0.2cm}
		...
		\subsection{Zyklische Ausführung}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.5]{/Bilder/ZyklischeAuftrennungAStarPDF}
				\vspace{0.2cm}
	...
	\section{Steuerung des Bearbeitungsablaufs}
		...
		\subsection{Bearbeitungsreihenfolge}
			...
			\begin{figure}[h]
				\centering
				\includegraphics[scale=0.8]{/Bilder/TIA_VehicleControlBlock}
				\vspace{0.2cm}
	...
	\section{Beispiel für eine einfache Routenberechnung}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.5]{/Bilder/Routenbeispiel1PDF}
			\vspace{0.2cm}
		...
		\begin{figure}[H]
			\centering
			\includegraphics[scale=0.5]{/Bilder/Routenbeispiel2PDF}
			\vspace{0.2cm}
